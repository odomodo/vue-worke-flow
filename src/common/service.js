...
export default {
    ...
    queryUserGroups() {
        return http.post('/api/workflow/user/group/select/page', { pageNum: 1, pageSize: 100, sourceCode: getUrlParams().sourceCode })
    },
    ...
    // 工作流主流程跟踪页面跳转到子流程跟踪页面：根据主流程实例id查询子流程实例id
    subInfo(option) {
        return http.post('/api/mdc/workflow/info/sub/info', option)
    },
